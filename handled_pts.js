...
$(".handledPts").on("click", function() {

    var table =
        `<table class="table table-striped table-hover" id="handled_pts_table">
                    <thead>
                        <tr class="info">
                             <th>ID</th>
                            <th>Sipariş No</th>
                    ...
                    <tbody id ="handled_pts_tbody"></tbody>
                    <tfoot>
                        <tr class="info">
                            <th>ID</th>
                            <th>Sipariş No</th>
    ...
    $.ajax({
        ...
        success: function (resp) {
            ...
            if (resp.status == 200) {
                ...
                console.log(resp);
                $("#handled_pts_tbody").empty();
                $("#handled_pts_tbody").append(appText);



                table= $("#handled_pts_table").DataTable({
                    scrollX:true,
                    language: {

    ...
    $(".tipped").on("click",function(){
        ...
        <thead>
            <th>
                ...
                <input class="form-control input-sm pltdate" id="start_date" placeholder="Başlangıç..." type="text" autocomplete="off" required="" >
                </div>
            </th>
            <th>
            ...
            <th>
                <div class="input-group">
                    <input class="form-control input-sm pltdate" id="end_date" placeholder="Bitiş..." type="text" autocomplete="off" required=""><span class="input-group-addon" style="margin-left: 0px"><i class="fa fa-calendar" ></i></span>
                </div>
            </th>
        </thead>
    </table>
                    ...
                    if (resp.status == 200) {
                        ...
                        $("#tipped_table").DataTable({
                            ...
                            buttons: [
                                {
                                    extend: 'excel' ,
                                    title: $("#start_date").val() + ' ile ' + $("#end_date").val() + ' arası',
